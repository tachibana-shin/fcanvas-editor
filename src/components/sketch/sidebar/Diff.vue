<template>
  <div className="w-full px-3" v-if="!acceptDiff">
  ...
  <div className="w-full" v-else>
    <div className="w-100 absolute top-0 left-0" v-if="loading">
      <q-linear-progress height="2px" />>
    </div>

    <div className="text-center text-sm mt-3" v-if="!diff || diff.count === 0">
      Not change
    </div>
