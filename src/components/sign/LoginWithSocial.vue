<template>
  <div
    className="text-center text-sm my-4 relative before:content-DEFAULT before:absolute before:left-0 before:top-[50%] before:w-full before:h-[1px] before:bg-[rgba(255,255,255,0.1)]"
  >
  ...
  <div className="text-center">
    ...
    >
      <Icon icon="uiw:github" width="1.5rem" height="1.5rem" className="mr-1" />
      Sign in with GitHub
    </Button>
  </div>
</template>
